...
create_vectorization_pipeline "courts" "full_name"
update_index_mapping_for_vectors "courts" "full_name"

# Citations - vectorize the case_name field
create_vectorization_pipeline "citations" "case_name"
update_index_mapping_for_vectors "citations" "case_name"

# Dockets - vectorize the case_name field
create_vectorization_pipeline "dockets" "case_name"
update_index_mapping_for_vectors "dockets" "case_name"

# Opinion - vectorize the plain_text field
create_vectorization_pipeline "opinion" "plain_text"
update_index_mapping_for_vectors "opinion" "plain_text"
